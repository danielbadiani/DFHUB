                                ...
                                {            
                                    ...
                                    ["fields"]= {
                                        ...
                                        },
                                        {
                                            ...
                                            ["value"]= "```Người dùng đã chạy script DF Hub Auto Farm Cảm Ơn Vì Đã Dùng RinX!!!!```",
                                            ["inline"]= true
                                            },
                                       {
                                     ["name"] = "𝙅𝙤𝙗 𝙄𝙙",
...
setclipboard("DF Hub Is The Best")
...
SaveManager:LoadAutoloadConfig()local KeyGuardLibrary = loadstring(game:HttpGet("https://cdn.keyguardian.org/library/v1.0.0.lua"))()
local trueData = "800118776fe04737a861af03be6d8d91"
local falseData = "e02db4fe87214395b6a664c204d8d14d"

KeyGuardLibrary.Set({
  publicToken = "7fdc9f5f54d449868cc603f6be054bad",
  privateToken = "bb5c74bd14674e1bbe1473fba39129f7",
  trueData = trueData,
  falseData = falseData,
})
